...
- [Bombastic Baths](#bombastic-baths)
...
- [Methodology](#methodology)
    + [Agile Project Management with GitHub Projects and GitHub Issues](#agile-project-management-with-github-projects-and-github-issues)
    + [Sprints](#sprints)
...
- [Business and Marketing Plan](#business-and-marketing-plan)
    ...
    + [Search Engine Optimization (SEO)](#search-engine-optimization--seo-)
      ...
      - [Keywords](#keywords)
        * [Short tailed keywords](#short-tailed-keywords)
        * [Long tailed keywords](#long-tailed-keywords)
      - [Implementation:](#implementation-)
        * [Sitemap.xml](#sitemapxml)
        * [Robots.txt](#robotstxt)
- [Database](#database)
- [Design (UI)](#design--ui-)
    + [Building a User-Friendly E-commerce Platform](#building-a-user-friendly-e-commerce-platform)
...
- [Deployment](#deployment)
  ...
  * [Register a domain with a domain registrar.](#register-a-domain-with-a-domain-registrar)
- [Credits](#credits)
    + [Code used](#code-used)
